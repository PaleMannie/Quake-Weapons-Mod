...
public class GrenadeProjectileModel extends EntityModel<EntityRenderState> {
    ...
    public static final ModelLayerLocation GRENADE_LAYER = new ModelLayerLocation(Identifier.fromNamespaceAndPath(QuakeWeapons.MODID, "grenade_projectile"), "main");
