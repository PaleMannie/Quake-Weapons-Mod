...
public class CellsAmmopickupModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation CELLS_AMMOPICKUP_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(QuakeWeapons.MODID, "cells_ammopickup"), "main");
