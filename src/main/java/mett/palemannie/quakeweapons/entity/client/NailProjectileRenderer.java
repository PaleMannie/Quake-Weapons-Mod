...
public class NailProjectileRenderer extends EntityRenderer<NailProjectileEntity, ProjectileRenderState> {
    ...
    public void extractRenderState(NailProjectileEntity pEntity, ProjectileRenderState renderState, float pPartialTick) {
