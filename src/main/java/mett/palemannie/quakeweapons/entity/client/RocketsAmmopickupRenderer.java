...
public class RocketsAmmopickupRenderer extends EntityRenderer<RocketsAmmopickupEntity, EntityRenderState> {
    ...
    private static final Identifier ROCKETS_AMMOPICKUP_LOCATION = Identifier.fromNamespaceAndPath(QuakeWeapons.MODID,"textures/entity/ammopickups/rockets_ammopickup.png");
    ...
    public void submit(EntityRenderState state, PoseStack poseStack, SubmitNodeCollector nodeCollector, CameraRenderState cameraState) {
        ...
        nodeCollector.submitModel(this.model, state, poseStack, this.model.renderType(ROCKETS_AMMOPICKUP_LOCATION), state.lightCoords, OverlayTexture.NO_OVERLAY, state.outlineColor, null);
        nodeCollector.submitModel(this.model, state, poseStack, RenderTypes.eyes(ROCKETS_AMMOPICKUP_LOCATION), state.lightCoords, OverlayTexture.NO_OVERLAY, state.outlineColor, null);
