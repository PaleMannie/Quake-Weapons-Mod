...
public class MegahealthPickupRenderer extends EntityRenderer<MegahealthPickupEntity> {

    private static final ResourceLocation MEGAHEALTH_PICKUP_LOCATION = ResourceLocation.fromNamespaceAndPath(QuakeWeapons.MODID,"textures/entity/ammopickups/megahealth_pickup.png");
    private final MegahealthPickupModel<MegahealthPickupEntity> model;
    ...
    public void render(MegahealthPickupEntity nailEntity, float v1, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        ...
        VertexConsumer $$6 = bufferSource.getBuffer(this.model.renderType(MEGAHEALTH_PICKUP_LOCATION));
        this.model.renderToBuffer(poseStack, $$6, packedLight, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);

        VertexConsumer $$5 = bufferSource.getBuffer(RenderType.eyes(MEGAHEALTH_PICKUP_LOCATION));
        this.model.renderToBuffer(poseStack, $$6, packedLight, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull MegahealthPickupEntity spit) { return MEGAHEALTH_PICKUP_LOCATION; }
