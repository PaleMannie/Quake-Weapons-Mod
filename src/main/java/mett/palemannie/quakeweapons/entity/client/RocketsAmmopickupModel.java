...
public class RocketsAmmopickupModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation ROCKETS_AMMOPICKUP_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(QuakeWeapons.MODID, "rockets_ammopickup"), "main");
