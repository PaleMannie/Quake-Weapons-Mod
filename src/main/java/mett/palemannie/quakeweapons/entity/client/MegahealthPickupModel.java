...
public class MegahealthPickupModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation MEGAHEALTH_PICKUP_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(QuakeWeapons.MODID, "megahealth_pickup"), "main");
