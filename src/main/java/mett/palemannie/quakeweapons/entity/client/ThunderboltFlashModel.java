...
public class ThunderboltFlashModel<T extends Entity> extends HierarchicalModel<T> {

    public static final ModelLayerLocation FLASH_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(QuakeWeapons.MODID, "thunderbolt_flash"), "main");
    private static final String MAIN = "main";
    private final ModelPart root;

    public ThunderboltFlashModel(ModelPart root) {
        this.root = root;
    }
