...
public class GrenadesAmmopickupRenderer extends EntityRenderer<GrenadesAmmopickupEntity, EntityRenderState> {

    private static final Identifier GRENADES_AMMOPICKUP_LOCATION = Identifier.fromNamespaceAndPath(QuakeWeapons.MODID,"textures/entity/ammopickups/grenades_ammopickup.png");
    private final GrenadesAmmopickupModel model;
