...
public class ShellsAmmopickupRenderer extends EntityRenderer<ShellsAmmopickupEntity> {
    ...
    private static final ResourceLocation SHELLS_AMMOPICKUP_LOCATION = ResourceLocation.fromNamespaceAndPath(QuakeWeapons.MODID,"textures/entity/ammopickups/shells_ammopickup.png");
    ...
    public void render(ShellsAmmopickupEntity nailEntity, float v1, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull ShellsAmmopickupEntity spit) { return SHELLS_AMMOPICKUP_LOCATION; }
