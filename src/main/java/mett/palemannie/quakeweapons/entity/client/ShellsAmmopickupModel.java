...
public class ShellsAmmopickupModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation SHELLS_AMMOPICKUP_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(QuakeWeapons.MODID, "shells_ammopickup"), "main");
