...
public class ShellsAmmopickupModel extends EntityModel<EntityRenderState> {
    ...
    public static final ModelLayerLocation SHELLS_AMMOPICKUP_LAYER = new ModelLayerLocation(Identifier.fromNamespaceAndPath(QuakeWeapons.MODID, "shells_ammopickup"), "main");
