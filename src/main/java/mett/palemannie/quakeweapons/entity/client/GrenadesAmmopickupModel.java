...
public class GrenadesAmmopickupModel extends EntityModel<EntityRenderState> {
    ...
    public static final ModelLayerLocation GRENADES_AMMOPICKUP_LAYER = new ModelLayerLocation(Identifier.fromNamespaceAndPath(QuakeWeapons.MODID, "grenades_ammopickup"), "main");
