...
public class GrenadesAmmopickupModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation GRENADES_AMMOPICKUP_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(QuakeWeapons.MODID, "grenades_ammopickup"), "main");
