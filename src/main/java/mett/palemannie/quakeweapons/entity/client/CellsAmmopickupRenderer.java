...
public class CellsAmmopickupRenderer extends EntityRenderer<CellsAmmopickupEntity, EntityRenderState> {

    private static final Identifier CELLS_AMMOPICKUP_LOCATION = Identifier.fromNamespaceAndPath(QuakeWeapons.MODID,"textures/entity/ammopickups/cells_ammopickup.png");
    private final CellsAmmopickupModel model;
    ...
    public void submit(EntityRenderState state, PoseStack poseStack, SubmitNodeCollector nodeCollector, CameraRenderState cameraState) {
        ...
        nodeCollector.submitModel(this.model, state, poseStack, this.model.renderType(CELLS_AMMOPICKUP_LOCATION), state.lightCoords, OverlayTexture.NO_OVERLAY, state.outlineColor, null);
        nodeCollector.submitModel(this.model, state, poseStack, RenderTypes.eyes(CELLS_AMMOPICKUP_LOCATION), state.lightCoords, OverlayTexture.NO_OVERLAY, state.outlineColor, null);
