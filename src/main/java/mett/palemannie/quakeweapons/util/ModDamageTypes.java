...
public class ModDamageTypes {
    ...
    public static final ResourceKey<DamageType> register(String name){
        return ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(QuakeWeapons.MODID, name));
    }
    ...
    public static final ResourceKey<DamageType> AXE_DAMAGE = register("axe_damage");
}
